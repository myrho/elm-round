...
data =
    ...
    , TestRow 0 "0" "0" "0" "0.0" "0.00"
    , TestRow 0 "0" "0" "0" "0.0" "0.00"
    , TestRow 99 "0" "90" "99" "99.0" "99.00"
    , TestRow 9.9 "0" "0" "9" "9.9" "9.90"
    , TestRow 0.99 "0" "0" "0" "0.9" "0.99"
    , TestRow 0.099 "0" "0" "0" "0.0" "0.09"
    , TestRow 0.0099 "0" "0" "0" "0.0" "0.00"
    , TestRow -99 "0" "-90" "-99" "-99.0" "-99.00"
    , TestRow -9.9 "0" "0" "-9" "-9.9" "-9.90"
    , TestRow -0.99 "0" "0" "0" "-0.9" "-0.99"
    , TestRow -0.099 "0" "0" "0" "0.0" "-0.09"
    ...
    , TestRow -213.01 "-200" "-210" "-213" "-213.0" "-213.01"
    , TestRow -213.001 "-200" "-210" "-213" "-213.0" "-213.00"
    , TestRow 5.5 "0" "0" "5" "5.5" "5.50"
    , TestRow 5.55 "0" "0" "5" "5.5" "5.55"
    , TestRow 5.555 "0" "0" "5" "5.5" "5.55"
    , TestRow 5.5555 "0" "0" "5" "5.5" "5.55"
    , TestRow -5.5 "0" "0" "-5" "-5.5" "-5.50"
    , TestRow -5.55 "0" "0" "-5" "-5.5" "-5.55"
    , TestRow -5.555 "0" "0" "-5" "-5.5" "-5.55"
    , TestRow -5.5555 "0" "0" "-5" "-5.5" "-5.55"
    , TestRow 5.5 "0" "0" "5" "5.5" "5.50"
    , TestRow 5.51 "0" "0" "5" "5.5" "5.51"
    , TestRow 5.501 "0" "0" "5" "5.5" "5.50"
    , TestRow 5.5001 "0" "0" "5" "5.5" "5.50"
    , TestRow -5.5 "0" "0" "-5" "-5.5" "-5.50"
    , TestRow -5.51 "0" "0" "-5" "-5.5" "-5.51"
    , TestRow -5.501 "0" "0" "-5" "-5.5" "-5.50"
    , TestRow -5.5001 "0" "0" "-5" "-5.5" "-5.50"
    , TestRow 4.9 "0" "0" "4" "4.9" "4.90"
    , TestRow 4.99 "0" "0" "4" "4.9" "4.99"
    , TestRow 4.999 "0" "0" "4" "4.9" "4.99"
    , TestRow 4.9999 "0" "0" "4" "4.9" "4.99"
    , TestRow -4.9 "0" "0" "-4" "-4.9" "-4.90"
    , TestRow -4.99 "0" "0" "-4" "-4.9" "-4.99"
    , TestRow -4.999 "0" "0" "-4" "-4.9" "-4.99"
    , TestRow -4.9999 "0" "0" "-4" "-4.9" "-4.99"
